...
# def initialize_model(variant, isPretrained=True):
#     if variant == 'resnet50':
#         print(f'{variant} {"pretrained" if isPretrained  else "trained from scratch"}')
#         if isPretrained:
...
# variants = {
#     'resnet50': initialize_model('resnet50'),
#     'resnet101': initialize_model('resnet101'),
#     'resnext50': initialize_model('resnext50'),
#     'resnet152': initialize_model('resnet152', False),
#     'vit_base_16': initialize_model('vit_base_16'),
#     'vit_base_32': initialize_model('vit_base_32'),
#     'vit_large_16': initialize_model('vit_large_16'),
#     'alexnet': initialize_model('alexnet'),
#     'vgg11': initialize_model('vgg11'),
#     'vgg11_bn': initialize_model('vgg11_bn'),
#     'vgg13': initialize_model('vgg13'),
#     'vgg16_bn': initialize_model('vgg16_bn'),
#     'vgg19_bn': initialize_model('vgg19_bn'),
#     'googlenet': initialize_model('googlenet')
# }
